...
const content = [
  {
    ...
    answer:
      "You can start right away—today even! You can begin making design requests immediately. There's no quicker way to get started on your design projects. Contact me.",
  },
  {
    question: "How does the design process work",
    answer: "We would first talk about your goal asynchronously or in a meeting. Once we know our clients' objectives we start to work. You will receive a client portal in Notion that will help you follow the whole process and deadlines."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. Artentii does not cover the following design work: 3D modeling, document design (medical forms, etc.), extensive print design (magazines, books, etc.).",
  },
  {
      ...
      {content.map((card, index) => (
        <div key={index} className="py-4 border-b-2 border-gray-light">
          <button onClick={() => toggleAccordion(index)} className="flex items-center justify-between w-full">
            <span key={index} className="text-left lg:text-lg text-gray-normal font-medium">{card.question}</span>
