        ...
        <div className="flex flex-col items-start gap-2 lg:gap-4 w-full 3xl:py-5">
          ...
          <div className="flex flex-col lg:flex-row gap-2 lg:gap-4 w-full">
            <a
              ...
              className="w-full text-white text-lg bg-purple lg:hover:-translate-y-1 shadow-button lg:hover:bg-white border-2 border-purple lg:hover:text-purple lg:hover:border-purple lg:hover:shadow-button-two cursor-pointer transition-all duration-300 ease-in-out px-8 lg:px-10 py-3 rounded-md"
            >
